...
export class UpdateDB1782276111209 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_535db815d07ae41f1499333f6c" ON "user_sedes" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_cef1b160cd22f22ef39934a93e" ON "user_sedes" ("sede_id") `,
    );
    ...
    await queryRunner.query(
      `UPDATE "resources" SET "sede_id" = $1 WHERE "sede_id" IS NULL AND "location" ILIKE '%florencia%'`,
      [SEDE_FLORENCIA_ID],
    );
    await queryRunner.query(
      `UPDATE "resources" SET "sede_id" = $1 WHERE "sede_id" IS NULL`,
      [SEDE_POLVORA_ID],
    );

    // 8. Ya con todas las filas pobladas, fijamos NOT NULL.
    await queryRunner.query(
      `ALTER TABLE "resources" ALTER COLUMN "sede_id" SET NOT NULL`,
    );

    // 9. Índice + FKs.
    await queryRunner.query(
      `CREATE INDEX "IDX_d4baca113d2dddb0b9c04ced1f" ON "resources" ("sede_id") `,
    );
    await queryRunner.query(
      `ALTER TABLE "resources" ADD CONSTRAINT "FK_d4baca113d2dddb0b9c04ced1ff" FOREIGN KEY ("sede_id") REFERENCES "sedes"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_sedes" ADD CONSTRAINT "FK_535db815d07ae41f1499333f6c2" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_sedes" ADD CONSTRAINT "FK_cef1b160cd22f22ef39934a93ef" FOREIGN KEY ("sede_id") REFERENCES "sedes"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user_sedes" DROP CONSTRAINT "FK_cef1b160cd22f22ef39934a93ef"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_sedes" DROP CONSTRAINT "FK_535db815d07ae41f1499333f6c2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "resources" DROP CONSTRAINT "FK_d4baca113d2dddb0b9c04ced1ff"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d4baca113d2dddb0b9c04ced1f"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_cef1b160cd22f22ef39934a93e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_535db815d07ae41f1499333f6c"`,
    );
