...
export class UpdateDB1781240616752 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('citizen', 'operator', 'admin')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."resources_type_enum" AS ENUM('court', 'ranch')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "resource_exceptions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "resource_id" uuid NOT NULL, "exception_date" date NOT NULL, "reason" text NOT NULL, "created_by_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_90ff52082238ee43a5f6d54dfa9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."reservations_status_enum" AS ENUM('pending_payment', 'under_review', 'approved', 'rejected', 'expired', 'cancelled')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_367cc7e5b7a79fe08066d82fd6" ON "reservations" ("resource_id", "reservation_date") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0244b15cc3f52c07735d2ea76d" ON "reservations" ("status", "payment_deadline") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."reservation_logs_from_status_enum" AS ENUM('pending_payment', 'under_review', 'approved', 'rejected', 'expired', 'cancelled')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."reservation_logs_to_status_enum" AS ENUM('pending_payment', 'under_review', 'approved', 'rejected', 'expired', 'cancelled')`,
    );
    await queryRunner.query(
      `CREATE TABLE "reservation_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "reservation_id" uuid NOT NULL, "from_status" "public"."reservation_logs_from_status_enum", "to_status" "public"."reservation_logs_to_status_enum" NOT NULL, "changed_by" uuid, "reason" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_74871dcf9ed2c7df8d0519d6645" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."payments_method_enum" AS ENUM('voucher', 'online')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."otp_codes_purpose_enum" AS ENUM('login', 'register')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_26eb05139ce60703f60cd1a2bf" ON "otp_codes" ("expires_at") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "resource_schedules" ADD CONSTRAINT "FK_40bfd8bd93d5b1f86738fcb2c62" FOREIGN KEY ("resource_id") REFERENCES "resources"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "resource_exceptions" ADD CONSTRAINT "FK_7ee6449c8fdd04ded5bbe440e9c" FOREIGN KEY ("resource_id") REFERENCES "resources"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "resource_exceptions" ADD CONSTRAINT "FK_c9630bb9b585d460314df82916f" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "reservations" ADD CONSTRAINT "FK_867b5da4d2d48942325efa3a828" FOREIGN KEY ("resource_id") REFERENCES "resources"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "reservation_logs" ADD CONSTRAINT "FK_4194cbece7719eaae50784de32e" FOREIGN KEY ("reservation_id") REFERENCES "reservations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "reservation_logs" ADD CONSTRAINT "FK_62fb1944dfe33dfdbcd1c6051da" FOREIGN KEY ("changed_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD CONSTRAINT "FK_9ed5ff4942e09edfd44ee0ccf01" FOREIGN KEY ("reservation_id") REFERENCES "reservations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD CONSTRAINT "FK_9753b8e19c636406e4aeab6d32c" FOREIGN KEY ("reviewed_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "system_config" ADD CONSTRAINT "FK_674473bbaa9859ba7e7d9f7ea9e" FOREIGN KEY ("updated_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "payments" DROP CONSTRAINT "FK_9753b8e19c636406e4aeab6d32c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "payments" DROP CONSTRAINT "FK_9ed5ff4942e09edfd44ee0ccf01"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reservation_logs" DROP CONSTRAINT "FK_62fb1944dfe33dfdbcd1c6051da"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reservation_logs" DROP CONSTRAINT "FK_4194cbece7719eaae50784de32e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reservations" DROP CONSTRAINT "FK_867b5da4d2d48942325efa3a828"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reservations" DROP CONSTRAINT "FK_4af5055a871c46d011345a255a6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "resource_exceptions" DROP CONSTRAINT "FK_c9630bb9b585d460314df82916f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "resource_exceptions" DROP CONSTRAINT "FK_7ee6449c8fdd04ded5bbe440e9c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "resource_schedules" DROP CONSTRAINT "FK_40bfd8bd93d5b1f86738fcb2c62"`,
    );
    await queryRunner.query(`DROP TABLE "audit_logs"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_26eb05139ce60703f60cd1a2bf"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."reservation_logs_to_status_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."reservation_logs_from_status_enum"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0244b15cc3f52c07735d2ea76d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_367cc7e5b7a79fe08066d82fd6"`,
    );
    await queryRunner.query(
